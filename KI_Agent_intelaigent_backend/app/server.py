...
# Twilio Handler
from app.voice.twilio_handler import handle_twilio_webhook, handle_twilio_status
from app.voice.test_handler import test_voice_webhook

# -------------------------------------------------
# Datenbank
# -------------------------------------------------
from app.database import engine, Base, get_db
import app.database_models  # wichtig für SQLAlchemy Metadata
...
# Services
from app.slots.dispatcher import get_slots_for_practice
from app.booking.booking_flow import process_booking_request
